<?php
$page_title = "LL.B. Programme | Kamkus College of Law";
$page_description = "A three-year Bachelor of Laws program designed for aspiring legal professionals at Kamkus College of Law";
...
<style>
/* Custom styles for LL.B. Programme page */
...
<main class="teaching-learning-page">
    ...
    <div class="hero-section">
        ...
        <img src="<?php echo $base_url; ?>src/assets/public/academics/llb1.jpg" 
             alt="LL.B. Programme at Kamkus College of Law" 
             class="hero-image"
            ...
            <div class="container">
                <div class="hero-text">
                    <div class="badge">
                        ...
                        <span>Professional Legal Studies</span>
                    </div>
                    <h1>LL.B. Programme</h1>
                    <p>A three-year Bachelor of Laws program designed for aspiring legal professionals</p>
                </div>
            ...
            <div class="content-grid">
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        <p>
                            The LL.B. program at Kamkus College of Law follows specific admission criteria and fee structure as per CCS University, Meerut guidelines. We maintain transparency in our admission process and ensure equal opportunities for all eligible candidates.
                        </p>
                        ...
                        <div class="feature-list">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p>Applicants must hold a Bachelor's degree (in any discipline) from a UGC-recognized university.</p>
                                </div>
                            </div>
                            
                            <div class="feature-item">
                                <div class="feature-icon">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M16.84,2.73C16.45,2.73 16.07,2.88 15.77,3.17L13.65,5.29C13.55,5.39 13.55,5.56 13.65,5.66L18.36,10.37C18.46,10.47 18.63,10.47 18.73,10.37L20.85,8.25C21.44,7.66 21.44,6.73 20.85,6.14L17.9,3.17C17.6,2.88 17.22,2.73 16.84,2.73M12.94,6L12,6.94L15.06,10L16,9.06L12.94,6M11.08,7.85L7.85,11.08L8.92,12.15L12.15,8.92L11.08,7.85M7,12.94L7.94,13.88L11.06,10.76L10.12,9.82L7,12.94M6.09,14.78L6.21,15.09L8.91,17.79L9.22,17.91L11.06,16.07L9.93,14.94L6.09,14.78M5.26,15.84L5.03,17.97L7.16,17.74L5.26,15.84Z"/></svg>
                                </div>
                                <div class="feature-text">
                                    <h4>Merit Basis</h4>
                                    <p>Admission to the LL.B. program is determined by merit basis conducted by CCS University, Meerut.</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h4>General & OBC Categories</h4>
                                    <p>Minimum 45% aggregate marks required in their qualifying Bachelor's degree & for Candidates of Uttar Pradesh OBC Candidates minimum 42% marks required. </p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h4>SC & ST Categories</h4>
                                    <p>For Residents of Uttar Pradesh minimum 40% aggregate marks required in their qualifying Bachelor's degree.</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h4>Fee Structure</h4>
                                    <p>The annual tuition fee for the LL.B. program for the 2025-26 session is ₹37,900.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        <p>
                            Our LL.B. program is designed to provide comprehensive legal education with emphasis on practical training, expert guidance, and holistic development. The program prepares students for various career opportunities in the legal field.
                        </p>
                        ...
                        <div class="feature-list">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p>Well-rounded legal education covering constitutional law, contracts, torts, criminal law, and more</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p>Learn from experienced professors and practicing legal professionals</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p>Gain hands-on experience through moot courts, legal aid clinics, and internships</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p>Prepare for careers in litigation, corporate law, civil services, and judiciary</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p>Develop research skills through projects and case studies critical for legal practice</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="program-grid">
                            ...
                            <a href="<?php echo $base_url; ?>academics/llb.php" class="program-link active">
                                <div class="program-icon">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.5,15.1L22.6,17.2L21.2,18.6L19.1,16.5L15.5,20.1C14.7,20.9 13.4,20.9 12.6,20.1L11.9,19.4C11.1,18.6 11.1,17.3 11.9,16.5L15.5,12.9L9.4,6.8L8.7,7.5C7.9,8.3 6.6,8.3 5.8,7.5L5.1,6.8C4.3,6 4.3,4.7 5.1,3.9L8.7,0.3C9.5,-0.5 10.8,-0.5 11.6,0.3L12.3,1C13.1,1.8 13.1,3.1 12.3,3.9L11.6,4.6L17.7,10.7L20.5,7.9C21.3,7.1 22.6,7.1 23.4,7.9C24.2,8.7 24.2,10 23.4,10.8L20.5,13.7V15.1Z"/></svg>
                                </div>
                                <div class="program-text">
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        <p style="margin-bottom: 16px; color: #64748b; font-size: 14px;">
                            Quick access to essential LL.B. program resources and information
                        </p>
                        
                        <div class="resource-grid">
                            <a href="<?php echo $base_url; ?>academics/llb/syllabus" class="resource-link">
                ...
                <div class="content-card" style="background: linear-gradient(135deg, #1E293B, #364559);">
                    ...
                    <div class="card-content" style="color: white;">
                        <p style="color: rgba(255, 255, 255, 0.9);">
                            Interested in joining our LL.B. program? Contact us for detailed information about admission process, eligibility criteria, and more.
                        </p>
