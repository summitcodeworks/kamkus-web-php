<?php
$page_title = "B.A. LL.B. Programme - Kamkus College of Law";
$page_description = "A five-year integrated program for aspiring legal professionals combining arts and law at Kamkus College of Law";
...
<style>
/* Custom styles for B.A. LL.B Programme page */
...
<main class="teaching-learning-page">
    ...
    <div class="hero-section">
        ...
        <img src="<?php echo $base_url; ?>src/assets/public/academics/ballbn2.jpg" 
             alt="B.A. LL.B. Programme at Kamkus College of Law" 
             class="hero-image"
            ...
            <div class="container">
                <div class="hero-text">
                    <div class="badge">
                        ...
                        <span>Integrated Legal Studies</span>
                    </div>
                    <h1>B.A. LL.B. Programme</h1>
                    <p>A five-year integrated program for aspiring legal professionals combining arts and law</p>
                </div>
            ...
            <div class="content-grid">
                ...
                <div class="main-content">
                    ...
                    <div class="content-card">
                        ...
                        <div class="card-content">
                            <p>
                                The B.A. LL.B. programme at Kamkus College of Law is a five-year integrated course that combines legal education with arts subjects. Our admission process ensures that we select dedicated students who are committed to excellence in legal education.
                            </p>
                            ...
                            <div class="feature-list">
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        <h4>Merit Basis</h4>
                                        <p>Admission to the B.A. LL.B. program is determined on Merit Basis conducted by CCS University, Meerut.</p>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <p>For Residents of Uttar Pradesh minimum 40% aggregate marks in 10+2 or equivalent examination.</p>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        <h4>Annual Fee</h4>
                                        <p>The annual tuition fee for the B.A. LL.B. program for the 2025-26 session is ₹37,900.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content-card">
                        ...
                        <div class="card-content">
                            <p>
                                The integrated B.A. LL.B. program offers several advantages for aspiring legal professionals, providing a comprehensive foundation in both legal and liberal arts education.
                            </p>
                            ...
                            <div class="feature-list">
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <p>Combines arts subjects with legal education, providing a broader academic foundation</p>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <p>Enter the legal profession one year earlier than traditional route</p>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <p>Develop skills in humanities subjects that complement legal studies</p>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <p>Access to a wider range of career options in legal and non-legal sectors</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content-card">
                        ...
                        <div class="card-content">
                            <p>
                                Key information about the B.A. LL.B. programme at Kamkus College of Law, including duration, structure, and fee details.
                            </p>
                            ...
                            <div class="feature-list">
                                ...
                                <div class="feature-item">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <p>Bachelor of Arts, Bachelor of Laws (B.A. LL.B.)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="sidebar">
                    ...
                    <div class="content-card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="program-grid">
                                ...
                                <a href="<?php echo $base_url; ?>academics/ba-llb.php" class="program-link active">
                                    <div class="program-icon">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12,2A2,2 0 0,1 14,4C14,4.74 13.6,5.39 13,5.73V7H14A7,7 0 0,1 21,14H22A1,1 0 0,1 23,15A1,1 0 0,1 22,16H21A7,7 0 0,1 14,23H10A7,7 0 0,1 3,16H2A1,1 0 0,1 1,15A1,1 0 0,1 2,14H3A7,7 0 0,1 10,7H11V5.73C10.4,5.39 10,4.74 10,4A2,2 0 0,1 12,2M12,4.5A0.5,0.5 0 0,0 11.5,4A0.5,0.5 0 0,0 12,3.5A0.5,0.5 0 0,0 12.5,4A0.5,0.5 0 0,0 12,4.5Z"/></svg>
                                    </div>
                                    <div class="program-text">
                    ...
                    <div class="content-card">
                        ...
                        <div class="card-content">
                            <p style="margin-bottom: 16px; color: #64748b; font-size: 14px;">
                                Quick access to essential B.A. LL.B. program resources and information
                            </p>
                            
                            <div class="resource-grid">
                                <a href="<?php echo $base_url; ?>academics/ba-llb-syllabus.php" class="resource-link">
                    ...
                    <div class="content-card" style="background: linear-gradient(135deg, #1E293B, #364559);">
                        ...
                        <div class="card-content" style="color: white;">
                            <p style="color: rgba(255, 255, 255, 0.9);">
                                Interested in joining our B.A. LL.B. program? Contact us for detailed information about admission process, eligibility criteria, and more.
                            </p>
