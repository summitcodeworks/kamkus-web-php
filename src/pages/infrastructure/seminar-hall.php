<?php
$page_title = "Seminar Hall - Kamkus College of Law";
$page_description = "Explore our state-of-the-art Seminar Hall equipped with modern facilities for academic discussions, presentations, and special events.";
...
<style>
/* Custom styles for Seminar Hall page */
...
<main class="teaching-learning-page">
    ...
    <div class="hero-section">
        ...
        <img src="<?php echo $base_url; ?>src/assets/public/infra/conf.jpg" 
             alt="Kamkus College of Law Seminar Hall" 
             class="hero-image"
        ...
        <div class="hero-content">
            <div class="container">
                <div class="hero-text">
                    ...
                    <h1>Seminar Hall</h1>
                    <p>A modern space for academic discussions, presentations, and special events</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="main-content">
                ...
                <div class="content-card">
                    <div class="card-header">
                        ...
                        <h3>About Our Seminar Hall</h3>
                    </div>
                    <div class="card-content">
                        <p>The Kamkus College of Law Seminar Hall is a state-of-the-art facility designed to host academic 
                        discussions, guest lectures, and special events. With modern architecture and thoughtful design, 
                        the seminar hall provides an ideal environment for intellectual exchange and professional development.</p>
                        
                        <p class="mt-4">Our seminar hall is equipped with advanced audio-visual equipment, comfortable seating, and 
                        excellent acoustics to ensure that every event is conducted smoothly and efficiently. The space 
                        is versatile enough to accommodate various types of events, from intimate discussions to larger conferences.</p>
                    </div>
                </div>
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        <p>Our seminar hall is equipped with state-of-the-art technology to enhance the event experience:</p>
                        ...
                        <div class="feature-list">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h4>Advanced Presentation System</h4>
                                    <p>High-definition projector and premium sound system for crystal-clear presentations</p>
                                </div>
                            </div>
                            
                            <div class="feature-item">
                                <div class="feature-icon">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12,2A3,3 0 0,1 15,5V11A3,3 0 0,1 12,14A3,3 0 0,1 9,11V5A3,3 0 0,1 12,2M19,11C19,14.53 16.39,17.44 13,17.93V21H11V17.93C7.61,17.44 5,14.53 5,11H7A5,5 0 0,0 12,16A5,5 0 0,0 17,11H19Z"/></svg>
                                </div>
                                <div class="feature-text">
                                    <h4>Professional Audio System</h4>
                                    <p>Surround Sound Audio System with multiple wireless microphones</p>
                                </div>
                            </div>

                            <div class="feature-item">
                                <div class="feature-icon">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20,8V6A2,2 0 0,0 18,4H6A2,2 0 0,0 4,6V8A2,2 0 0,0 2,10V14A2,2 0 0,0 4,16H6V20H8V16H16V20H18V16H20A2,2 0 0,0 22,14V10A2,2 0 0,0 20,8M6,6H18V8H6V6Z"/></svg>
                                </div>
                                <div class="feature-text">
                                    <h4>Comfortable Seating</h4>
                                    <p>Excellent acoustics and comfortable seating for all attendees</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <p>High-speed internet access for all attendees</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        <p>Our seminar hall regularly hosts a variety of academic and professional events:</p>
                        
                        <div class="feature-list">
                            <?php
                            $events = [
                                ["Guest Lectures", "Presentations by distinguished professionals and academics"],
                                ["Academic Symposiums", "Discussions on current legal topics and developments"],
                                ["Workshops", "Hands-on learning opportunities for students"],
                                ["Moot Court Competitions", "Simulation of court proceedings for practical experience"],
                                ["Alumni Meetings", "Networking events connecting past and present students"]
                            ];
            ...
            <div class="sidebar">
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="infrastructure-grid">
                            <a href="<?php echo $base_url; ?>infrastructure/seminar-hall.php" class="infrastructure-link active">
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        <p style="margin-bottom: 16px; color: #64748b; font-size: 14px;">
                            Advanced technical features and specifications of our seminar hall
                        </p>
                        
                        <div class="resource-grid">
                            <a href="#" class="resource-link">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M21,3H3C1.89,3 1,3.89 1,5V17A2,2 0 0,0 3,19H8V21H16V19H21A2,2 0 0,0 23,17V5C23,3.89 22.1,3 21,3M21,17H3V5H21V17Z"/></svg>
                                <span>4K Resolution Projector</span>
                            </a>
                            
                            <a href="#" class="resource-link">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3,9V15H7L12,20V4L7,9H3Z"/></svg>
                            ...
                            <a href="#" class="resource-link">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12,2A7,7 0 0,0 5,9C5,11.38 6.19,13.47 8,14.74V17A1,1 0 0,0 9,18H15A1,1 0 0,0 16,17V14.74C17.81,13.47 19,11.38 19,9A7,7 0 0,0 12,2M9,21V20H15V21A1,1 0 0,1 14,22H10A1,1 0 0,1 9,21Z"/></svg>
                                <span>Adjustable Lighting</span>
                            </a>
                            
                            <a href="#" class="resource-link">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M16 4C18.2 4 20 5.8 20 8S18.2 12 16 12 12 10.2 12 8 13.8 4 16 4M16 14C20.4 14 24 15.8 24 18V20H8V18C8 15.8 11.6 14 16 14M8.5 11C10.4 11 12 9.4 12 7.5S10.4 4 8.5 4 5 5.6 5 7.5 6.6 11 8.5 11M8.5 13C5.7 13 0 14.4 0 17.2V20H7V18C7 16.9 7.2 15.4 8.5 13Z"/></svg>
                                <span>150 Person Capacity</span>
                            </a>
                ...
                <div class="content-card" style="background: linear-gradient(135deg, #1E293B, #364559);">
                    <div class="card-header" style="background: transparent;">
                        ...
                        <h3 style="color: white;">Booking Inquiry</h3>
                    </div>
                    <div class="card-content" style="color: white;">
                        <p style="color: rgba(255, 255, 255, 0.9);">
                            Interested in booking our seminar hall for events, lectures, or conferences? Contact our administrative office for scheduling and detailed information.
                        </p>
